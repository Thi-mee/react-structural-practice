  ...
  return (
    <Container
      ...
      <Form
        ...
        size="sm"
        backgroundColor="#111"
        initialState={{ email: "", password: "", shouldRemember: false }}>
        <TextField type="email" name="email" label="Email" />
        <TextField type="password" name="password" label="Password" />
        <CheckBox label="Remember me" name="shouldRemember" width="48.6%" />
        <Text color="#99f" align="right" width="48.6%">
